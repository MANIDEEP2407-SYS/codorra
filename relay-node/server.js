...
app.post('/deposit', async (req, res) => {
  const {
    ...
    publicKeyB64, recipients, releaseMessage, heartbeatInterval, gracePeriod,
  ...
  db.prepare(`
    INSERT OR REPLACE INTO vaults (
      ...
      release_message, heartbeat_interval, grace_period, missed_heartbeats,
...
app.listen(PORT, () => {
  console.log(`[NODE_${NODE_ID}] TruthSwitch relay online at http://localhost:${PORT}`);
  startWatchdog();
});
